...
$.getJSON("http://www.cityplanner.it/php/bootleaf-master/data/boroughs.geojson", function (data) {
...
$.getJSON("http://www.cityplanner.it/php/bootleaf-master/data/subways.geojson", function (data) {
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "http://www.cityplanner.it/php/bootleaf-master/assets/img/arbol.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.NAME + 
"</td></tr>" + "<tr><th>Autore</th><td>" + feature.properties.TEL + "</td></tr>" + 
"<tr><th>Address</th><td>" + feature.properties.ADDRESS1 + "</td></tr>" + 
"<tr><th>Website</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'><img src='" + feature.properties.picture + "' width='100%'></a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
*/
$.getJSON("http://www.cityplanner.it/experiment_host/supply/textfile.json", function (data) {
  theaters.addData(data);
  map.addLayer(theaterLayer);
});
...
var museums = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "http://www.cityplanner.it/php/bootleaf-master/assets/img/museum.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
map = L.map("map", {
  ...
  center: [43.36954069999999, 11.360057600000005],
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='http://www.cityplanner.it/php/bootleaf-master/assets/img/arbol.png' width='24' height='28'>&nbsp;Trees": theaterLayer,
    "<img src='http://www.cityplanner.it/php/bootleaf-master/assets/img/museum.png' width='24' height='28'>&nbsp;Garden": museumLayer
  }/*,
  "Reference": {
    "Boroughs": boroughs,
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='http://www.cityplanner.it/php/bootleaf-master/assets/img/arbol.png' width='24' height='28'>&nbsp;Theaters</h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='http://www.cityplanner.it/php/bootleaf-master/assets/img/museum.png' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
