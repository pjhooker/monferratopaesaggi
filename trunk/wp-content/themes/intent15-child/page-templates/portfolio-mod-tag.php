...
<?php
  ...
  $mykey_values = get_post_custom_values('tag_percorso_template');
      foreach ( $mykey_values as $key => $value ) {
        $tag=$value;
        if ($tag=='crea') {$nome_vero='crea';$active_crea='class="active" ';}else{$active_crea='';}
        if ($tag=='bosco' /*BRIC*/) {$nome_vero='bric';$active_bosco='class="active" ';}else{$active_bosco='';}
        if ($tag=='po') {$nome_vero='po';$active_po='class="active" ';}else{$active_po='';}
        if ($tag=='miniera' /*MINIERE*/) {$nome_vero='miniere';$active_miniera='class="active" ';}else{$active_miniera='';}
        if ($tag=='grignolino'/*VIGNE*/) {$nome_vero='vigne';$active_grignolino='class="active" ';}else{$active_grignolino='';}
        if ($tag=='sud'/*PROFILI*/) {$nome_vero='profili';$active_sud='class="active" ';}else{$active_sud='';}
    }
?>         
