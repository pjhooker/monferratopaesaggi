...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"  style='background-color:#386DBD;'>
      <div class="navbar-header" style='background-color:#386DBD;'>
        ...
        <span class="navbar-brand">Percorsi</span>
      </div>
...
?>
          <li><a href="../geodata/<?php $geodata = get_field('geodata',$id); echo $geodata;?>.kml" style="color: white;">
          <i class="fa fa-list" style="color: white"></i>Download KML</a>
          </li>
        </ul>
      </div><!--/.navbar-collapse -->
    </div>
        ...
        <div class="panel panel-default" style="margin: 0px; border: none; border-radius: 0px; -webkit-box-shadow: none; box-shadow: none;">
          ...
          <div class="panel-body">
            ...
            <ul class="nav nav-tabs" id="poi-tabs">
              <li class="active"><a href="#theaters" onclick="$('#poi-tabs a[href=\'#theaters\']').tab('show'); return false;"><img src="<?php echo $icon1;?>" height="16px" width="14px">&nbsp;POI</a></li>
            ...
            <ul class="nav nav-tabs" id="aboutTabs">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#theaters-tab" data-toggle="tab">Trees</a></li>
    ...
    <script src="http://www.cityplanner.it/experiment_host/php/bootleaf-master/assets/leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.js"></script>
    <script src="http://www.cityplanner.it/experiment_host/php/bootleaf-master/assets/leaflet-activearea/L.activearea.js"></script>
    <script src="http://www.cityplanner.it/experiment_host/php/bootleaf-master/assets/leaflet-sidebar-0.1.5/L.Control.Sidebar.js"></script>
...
var subwayLines = L.geoJson(null, {
  style: function (feature) {
    if (feature.properties.idm === 1997) {
      return {
        color: <?php colore_percorso('1997') ?>,
        weight: 3,
        opacity: 1
      };
    }
    if (feature.properties.idm === 1993) {
      return {
        color: <?php colore_percorso('1993') ?>,
        weight: 3,
        opacity: 1
      };
    }
    if (feature.properties.idm === 1989) {
      return {
        color: <?php colore_percorso('1989') ?>,
        weight: 3,
        opacity: 1
      };
    }
    if (feature.properties.idm === 1987) {
      return {
        color: <?php colore_percorso('1987') ?>,
        weight: 3,
        opacity: 1
      };
    }
    if (feature.properties.idm === 1971) {
      return {
        color: <?php colore_percorso('1971') ?>,
        weight: 3,
        opacity: 1
      };
    }
    if (feature.properties.idm === 1969) {
      return {
        color: <?php colore_percorso('1969') ?>,
        weight: 3,
        opacity: 1
      };
    }
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
	    ...
	    return L.marker(latlng, {
	      ...
	      title: feature.properties.titolo,
	      riseOnHover: true
	    });
  },
  onEachFeature: function (feature, layer) {

                if (feature.properties.picture === 'noimage') {
                var image = "";
                } else {
                var image = "<img src='" + feature.properties.picture + "' style='width:100%;height:auto;' />";
                }
                var icon = getIcon(feature.properties.tipo);
    if (feature.properties) {
      var content = ""
      + "<table class='table table-striped table-bordered table-condensed'>"
      + "<tr><th>Tipo POI</th><td>"
      + "<img src='"
      + icon
      ...
      + "</td></tr>"
      + "<tr><th>Scheda completa</th><td><a class='url-break' href='"
      + feature.properties.url_post
      + "' target='_blank'>apri nel browser</a>"
      + "</td></tr>"
      + "<tr><td colspan='2'>"
      + image
      + "</td></tr>"
      ...
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.titolo);
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
      ...
      $("#theater-table tbody").append('<tr style="cursor: pointer;" onclick="sidebarClick('+L.stamp(layer)+'); return false;"><td class="theater-name">'+layer.feature.properties.titolo+'<i class="fa fa-chevron-right pull-right"></td></tr>');
      theaterSearch.push({
        name: layer.feature.properties.titolo,
...
<?php
$geodata_poi = get_field('geodata_poi',$id);
?>
...
map = L.map("map", {
  ...
  center: [45.100644, 8.281982],
  layers: [mapquestOSM, subwayLines, markerClusters, highlight],
  zoomControl: false,
...
$(document).one("ajaxStop", function () {
  ...
  map.fitBounds(subwayLines.getBounds());
  $("#loading").hide();
