...
<div id="front-blog">
	<div id="front-blog-inner" class="front container fix">
		...
		<?php $my_query = "ignore_sticky_posts=1&showposts=4&cat=".$cat; $my_query = new WP_Query($my_query); ?>
		...
		<?php $classes = ('3'==$my_query->current_post)?'entry one-fourth last':'entry one-fourth'; ?>
			...
			<article id="entry-<?php the_ID(); ?>" <?php post_class($classes); ?>>
				...
				<div class="entry-thumbnail">
					<a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'intent'), the_title_attribute('echo=0')); ?>">
