...
$cat1 = wpb_option('featured-cat-1');
$cat2 = wpb_option('featured-cat-2');
$cat1_num = wpb_option('featured-cat-1-num');
...
?>
			...
			<article <?php post_class(); ?>>
				<a class="item-small" href="<?php the_permalink(); ?>">
					...
					<span class="featured-title"><?php echo wpb_limit_characters(get_the_title(),54); ?></span>
					<span class="featured-excerpt"><?php echo wpb_limit_characters(get_the_excerpt(),140); ?></span>
				</a>
			</article>
			<?php endwhile; ?>
...
if(!wpb_option('featured-content')) {
	# Reset post data
	wp_reset_postdata();
